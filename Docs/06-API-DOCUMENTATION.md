...
- Max file size: 5MB (to reduce storage costs)
- Allowed formats: JPEG, PNG, GIF, WebP
- Images are automatically optimized and converted to WebP
- Stored on: Cloudflare R2 (free 10GB) or Backblaze B2 ($0.005/GB)
...
- Max file size: 50MB (to reduce storage and bandwidth costs)
- Allowed formats: MP4, WebM (optimized codecs)
- Max duration: 3 minutes
- Stored on: Cloudflare R2 or Backblaze B2
